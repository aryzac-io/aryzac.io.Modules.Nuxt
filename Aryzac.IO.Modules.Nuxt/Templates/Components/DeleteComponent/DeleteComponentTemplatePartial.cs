...
namespace Aryzac.IO.Modules.Nuxt.Templates.Components.DeleteComponent
{
    ...
    partial class DeleteComponentTemplate : IntentTemplateBase<OperationModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Nuxt.Components.DeleteComponent";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public DeleteComponentTemplate(IOutputTarget outputTarget, OperationModel model) : base(TemplateId, outputTarget, model)
        {
        ...
        public string GetBodyClassName()
        {
            ...
            return endpoint.InternalElement.Name;
        }
