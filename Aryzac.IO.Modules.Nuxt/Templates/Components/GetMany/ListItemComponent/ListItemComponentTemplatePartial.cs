...
namespace Aryzac.IO.Modules.Nuxt.Templates.Components.GetMany.ListItemComponent
{
    ...
    partial class ListItemComponentTemplate : IntentTemplateBase<OperationModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Nuxt.Components.GetMany.ListItemComponent";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public ListItemComponentTemplate(IOutputTarget outputTarget, OperationModel model) : base(TemplateId, outputTarget, model)
        {
