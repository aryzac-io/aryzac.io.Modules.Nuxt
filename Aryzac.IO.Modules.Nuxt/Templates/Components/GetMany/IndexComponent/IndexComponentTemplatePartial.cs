...
namespace Aryzac.IO.Modules.Nuxt.Templates.Components.GetMany.IndexComponent
{
    ...
    partial class IndexComponentTemplate : IntentTemplateBase<OperationModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Nuxt.Components.GetMany.IndexComponent";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public IndexComponentTemplate(IOutputTarget outputTarget, OperationModel model) : base(TemplateId, outputTarget, model)
        {
