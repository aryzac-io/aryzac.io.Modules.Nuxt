...
namespace Aryzac.IO.Modules.Nuxt.Templates.Components.PutPatchComponent
{
    ...
    partial class PutPatchComponentTemplate : IntentTemplateBase<OperationModel>
    {
        [IntentManaged(Mode.Fully)]
        public const string TemplateId = "Aryzac.IO.Modules.Nuxt.Components.PutPatchComponent";

        [IntentManaged(Mode.Merge, Signature = Mode.Fully)]
        public PutPatchComponentTemplate(IOutputTarget outputTarget, OperationModel model) : base(TemplateId, outputTarget, model)
        {
